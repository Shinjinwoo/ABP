...
#ifndef ABP_IOS_SWIFT_H
#define ABP_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ABP_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ABP_iOS11AppDelegate")
...
SWIFT_CLASS("_TtC7ABP_iOS28RefereeCounterViewController")
@interface RefereeCounterViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7ABP_iOS13SceneDelegate")
...
SWIFT_CLASS("_TtC7ABP_iOS27StadiumWetherViewController")
@interface StadiumWetherViewController : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
